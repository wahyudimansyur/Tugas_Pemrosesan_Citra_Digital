...
octave_image_pkg::strel::strel (const octave_value& arg)
{
  octave_value se = arg;
...
octave_image_pkg::strel::strel (const boolNDArray& nhood, const NDArray& height)
...
boolNDArray
octave_image_pkg::strel::get_nhood (void) const
{
  return nhood;
}

octave_idx_type
octave_image_pkg::strel::get_nnz (void) const
{
  return nnz;
}

Array<octave_idx_type>
octave_image_pkg::strel::get_origin (void) const
{
  return origin;
}

octave_image_pkg::strel
octave_image_pkg::strel::operator () (const octave_idx_type& i) const
{
...
octave_idx_type
octave_image_pkg::strel::numel (void) const
{
...
octave_image_pkg::strel
octave_image_pkg::strel::reflect (void) const
{
  ...
  return octave_image_pkg::strel (ref_nhood, ref_height, ref_origin);
}

void
octave_image_pkg::strel::set_origin (const Array<octave_idx_type>& sub)
{
  origin = sub;
  validate_origin ();
  return;
...
bool
octave_image_pkg::strel::flat (void) const
{
  bool flat = true;
...
Array<octave_idx_type>
octave_image_pkg::strel::offsets (const dim_vector& cum_size) const
{
...
Array<octave_idx_type>
octave_image_pkg::strel::pre_pad (const octave_idx_type& mt_ndims,
...
Array<octave_idx_type>
octave_image_pkg::strel::post_pad (const octave_idx_type& mt_ndims,
                                const std::string& shape) const
{
  Array<octave_idx_type> pad (dim_vector (mt_ndims, 1), 0);
...
void
octave_image_pkg::strel::ini_ctor ()
{
  size    = nhood.dims ();
  ndims   = nhood.ndims ();
  nnz     = nhood.nnz ();
...
Array<octave_idx_type>
octave_image_pkg::strel::default_origin ()
{
...
void
octave_image_pkg::strel::end_ctor (void)
{
...
void
octave_image_pkg::strel::validate_origin (void)
{
